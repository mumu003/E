  ...
  export default {
    data () {
      return {
        ...
        formItem: {
          beginDate:"",
          endDate:"",
          userId:sessionStorage.operationDetailUserId
        },
        //表格
        tableConfig:{
          url:"/api/emaint/repairProblem/repairProblemListListByUser",
              columns:[
                {
                  title: '单号',
                  key: 'workOrderNo',
    ...
    methods: {
      ...
      exportTabel(){
        ...
        let url=axios.defaults.baseURL+"/api/emaint/repairProblem/exportUserProblemDetailsData?beginDate="+begin+"&endDate="+end+"&accessToken="+sessionStorage.token+"&userId="+sessionStorage.operationDetailUserId
        location.href=url
      },
      //开始时间
